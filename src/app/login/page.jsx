  ...
  return (
    <div className="max-w-7xl mx-auto my-3">
        <div className="text-center my-3">
            <h1 className="text-3x font-bold"> Login</h1>
      ...
      <Card className="border rounded none">
        ...
        <div className="flex justify-center items-center gap-3">
                ...
                <div>
                    <Button onClick={handleGoogleSignin} variant="outline" className={'w-full rounded-none '}> <FcGoogle/> Login with Google </Button>
                </div>
      </Card>
    </div>
  );
